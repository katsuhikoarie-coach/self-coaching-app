...
define('DB_NAME', 'asagiri_sales');      // CORESERVERで作成したDB名
define('DB_USER', 'asagiri_sales');      // DB/ユーザー名（DB名と同一）
define('DB_PASS', 'asa123giri');         // DBパスワード
...
// CORS設定
header('Access-Control-Allow-Origin: https://sales.asagiriyamano.jp');
